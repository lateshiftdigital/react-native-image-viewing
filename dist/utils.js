...
export const getImageTranslate = (imageDimensions, layout) => {
...
export const getImageDimensionsByTranslate = (translate, layout) => {
    const { width, height } = layout;
    return {
...
export const getImageTranslateForScale = (currentTranslate, targetScale, layout) => {
    const { width, height } = getImageDimensionsByTranslate(currentTranslate, layout);
