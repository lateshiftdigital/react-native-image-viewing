...
export declare const getImageTranslate: (imageDimensions: Dimensions, layout: Dimensions) => Position;
export declare const getImageDimensionsByTranslate: (translate: Position, layout: Dimensions) => Dimensions;
export declare const getImageTranslateForScale: (currentTranslate: Position, targetScale: number, layout: Dimensions) => Position;
